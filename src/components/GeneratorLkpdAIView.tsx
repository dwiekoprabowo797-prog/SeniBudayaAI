      ...
      <div className="bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-900 text-white rounded-2xl p-6 md:p-8 shadow-xl border border-blue-800">
        <div className="max-w-3xl space-y-4">
          ...
          <p className="text-slate-200 text-sm md:text-base leading-relaxed">
            Layanan Generator Lembar Kerja Peserta Didik (LKPD) AI dialihkan langsung ke laman resmi SMP Negeri 10 Tarakan AI terintegrasi di luar aplikasi. Klik tombol di bawah untuk membuka prompt dan templat LKPD otomatis.
          </p>
