...
export const GeneratorPerangkatAjarAIView: React.FC<GeneratorPerangkatAjarAIViewProps> = ({ config }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    teacher: config.Nama_Guru || "Dwi Eko Prabowo, S.Pd.",
    nipTeacher: config.NIP_Guru || "198509032024211009",
    ...
    cpRasional: "Pada akhir Fase D, peserta didik mampu menuangkan gagasan dan pengamatannya ke dalam karya seni rupa dua atau tiga dimensi dengan menggunakan memori, pengamatan langsung, atau rekonstruksi. Peserta didik terampil menggunakan alat, bahan, dan teknik yang sesuai secara aman dan bertanggung jawab. Peserta didik juga mampu menganalisis, merefleksikan, dan mengevaluasi efektivitas karya pribadi maupun orang lain dengan menggunakan istilah seni rupa yang tepat, serta mampu mengaitkan karya seni dengan konteks budaya atau sejarah.",
    cpElemen: `Elemen 1 — Mengalami (Experiencing):
Peserta didik mampu mengamati, mengenali, dan merekam objek atau fenomena di lingkungan sekitar. Peserta didik mampu mengeksplorasi alat, bahan, media, prosedur, dan teknik dalam berkarya seni. Peserta didik mampu menunjukkan kepekaan terhadap keindahan dan nilai-nilai estetis dalam kehidupan sehari-hari.

Elemen 2 — Merefleksikan (Reflecting):
Peserta didik mampu menghargai, menganalisis, dan mengevaluasi karya seni diri sendiri maupun orang lain. Peserta didik mampu memberikan umpan balik yang kritis, objektif, dan konstruktif terhadap sebuah karya seni. Peserta didik mampu menghubungkan karya seni dengan konteks budaya, sejarah, atau tren sosial kemasyarakatan.

Elemen 3 — Berpikir dan Bekerja Artistik (Thinking and Working Artistically) :
Peserta didik mampu merancang, merencanakan, dan mengembangkan gagasan kreatif menjadi sebuah konsep karya seni. Peserta didik mampu menggunakan penguasaan teknik, alat, dan prosedur berkarya secara mandiri dan inovatif. Peserta didik mampu menyelaraskan ide kreatif dengan keterampilan teknis untuk menghasilkan karya yang orisinal.

Elemen 4 — Menciptakan (Creating):
Peserta didik mampu memproduksi, mewujudkan, dan menyajikan karya seni (visual, audio, tari, atau pertunjukan) yang bermakna. Peserta didik mampu memilih dan mengombinasikan elemen-elemen seni untuk menyampaikan pesan atau ekspresi pribadi. Peserta didik mampu menciptakan karya seni yang menunjukkan struktur, komposisi, dan teknik yang matang.

Elemen 5 — Berdampak (Impacting):
Peserta didik mampu menghasilkan karya seni yang memberikan respons, kesan, atau dampak positif bagi diri sendiri dan lingkungan sekitar. Peserta didik mampu membangun kesadaran sosial, kelestarian budaya, atau nilai kemanusiaan melalui proses berkarya seni.`
  });
  ...
  const handleFillSample = () => {
    setFormData({
      ...
      level: "Fase D / Kelas VII",
      year: "2026/2027",
      totalJp: "180 JP / Tahun",
      jpPerMinggu: "5 JP/Minggu",
      teacher: config.Nama_Guru || "Basuki Rahmat, S.Kom.",
      nipTeacher: config.NIP_Guru || "198804242025211058",
      cityDate: `${config.Tempat_Tanda_Tangan || "Tarakan"}, 14 Juli 2026`,
      principal: config.Nama_Kepsek || "IBRAHIM, M.Pd.",
      nipPrincipal: config.NIP_Kepsek || "197802152008011021",
